...
| Agent | File | Role |
|-------|------|------|
| Architect | `architect.py` | HTML structure + Tailwind classes |
| Alchemist | `alchemist.py` | Premium CSS effects |
| Physicist | `physicist.py` | Vanilla JS interactions |
| Strategist | `strategist.py` | Planning & Design DNA extraction |
| QualityGuard | `quality_guard.py` | QA validation |
| Critic | `critic.py` | Art direction feedback |
| Visionary | `visionary.py` | Vision API image analysis |
