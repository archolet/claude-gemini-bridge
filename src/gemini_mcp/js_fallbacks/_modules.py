"""JavaScript module definitions for frontend components.

Contains JSModule dataclass and all module definitions:
- utils: Core utility functions
- intersection_observer: Scroll animations
- dropdown: Smart positioning dropdowns
