"""Internal data storage for few-shot examples.

This module contains the raw example data. It should not be imported directly.
Use gemini_mcp.few_shot_examples instead for lazy-loaded access.

WARNING: Importing this module directly will load all examples into memory.
"""
